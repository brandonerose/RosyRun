...
# RosyRun <img src="inst/app/www/logo.png" align="right" height="150" />
...
## RosyRun Installation

RosyRun is designed to...

``` r
# install remotes package if you don't have it
# install.packages("remotes") 
remotes::install_github("brandonerose/RosyRun")
```

## RosyRun Example

RosyRun can be use like this...
...
The RosyRun package is at [github.com/brandonerose/RosyRun](https://github.com/brandonerose/RosyRun "RosyRun R package")
See instructions above. Install remotes and install RosyRun
